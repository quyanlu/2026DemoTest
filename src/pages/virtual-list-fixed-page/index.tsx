...
import VirtualListFixed, { VirtualListFixedProps } from '../../components/virtual-list-fixed';
import './index.scss';
...
const VirtualListFixedPage: React.FC = () => {
...
export default VirtualListFixedPage;